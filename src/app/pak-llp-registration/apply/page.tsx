...
export default function PakLlpRegistrationApplyPage() {
  const service = getServiceBySlug("pak-llp-registration");
  if (!service) notFound();
  return (
      ...
      <div className="mx-auto w-full max-w-[1200px]">
        <div className="mb-10 max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-fm-body text-[var(--fm-text-secondary)]">
            Complete your LLP registration application with the required company, contact and CNIC
            details.
          </p>
        </div>
        <Card
        ...
        >
          ...
          <StartApplicationButton serviceSlug="pak-llp-registration" size="lg" className="shrink-0">
            Proceed to payment →
