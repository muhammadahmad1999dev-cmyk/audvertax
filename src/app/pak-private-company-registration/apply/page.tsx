...
export default function PakPrivateCompanyRegistrationApplyPage() {
  const service = getServiceBySlug("pak-private-company-registration");
  if (!service) notFound();
  return (
      ...
      <div className="mx-auto w-full max-w-[1200px]">
        <div className="mb-10 max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-fm-body text-[var(--fm-text-secondary)]">
            Complete your private company registration application with the required company,
            contact and CNIC details.
          </p>
        </div>
        <Card
          variant="elevated"
        ...
        >
          <div>
            ...
            <p className="mt-2 text-3xl font-bold tracking-[-.04em] text-[var(--fm-text-primary)]">
              PKR 5,000{" "}
              <span className="text-base font-medium text-[var(--fm-text-secondary)]">
                + government fees
              </span>
            </p>
          </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_340px]">
          <Card variant="standard" className="p-6 sm:p-8">
            ...
            <div className="mt-6 divide-y divide-[var(--fm-border)]">
              {[
                "Owner CNIC — front and back",
                "Director CNIC — front and back",
          ...
          <Card variant="standard" className="p-6 sm:p-8">
            ...
            <p className="mt-6 text-sm leading-6 text-[var(--fm-text-secondary)]">
              PKR 5,000 is the Foremint service fee. Government registration fees are additional.
            </p>
          </Card>
        </div>
      </div>
