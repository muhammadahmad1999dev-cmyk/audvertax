...
export default function UKDirectorIdVerificationApplication() {
  ...
  async function onSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      fd.append(
        "application",
        JSON.stringify({ service: "uk-director-id-verification", data, documents }),
      );
      fd.append("director_identity_document", passport.file, passport.id);
      fd.append("director_address_document", bank.file, bank.id);
    ...
    <main className="fm-application-page">
      <div className="fm-application-container">
        <header className="fm-application-page-header">
          <p className="fm-application-header-badge-text">UK compliance</p>
          ...
          <p className="fm-application-description">
            Provide the director and LTD details required for identity verification.
          </p>
        </header>
        <form onSubmit={onSubmit} className="fm-application-form">
          <section className="fm-application-section">
            <h2 className="fm-application-section-title">Verification details</h2>
